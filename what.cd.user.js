...
// @updateURL 192.168.1.70/userscript/what.cd.user.js
// @require https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js
// @require https://raw.githubusercontent.com/Hunter16g/upgraded-system/main/jquery.noty.packaged.min.js
// @require https://greasemonkey.github.io/gm4-polyfill/gm4-polyfill.js
// ==/UserScript==

var torrentsInfoUrl = '192.168.1.70/json/torrents_info';
var addTorrentUrl = '192.168.1.70/json/add_torrent';
var transcodeRequestUrl = '192.168.1.70/transcode/request';
var downloadUrl = '192.168.1.70/download/zip/';
    ...
    $.each(result, function (i, resp) {
        ...
        if (resp.status == 'downloaded') {
            ...
            link.click(function (e) {
                e.preventDefault();
                playerUrl = '192.168.1.70/player/?playlist=what/' + resp.id;
